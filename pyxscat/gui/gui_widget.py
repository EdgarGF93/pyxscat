...
from gui.gui_layout import GUIPyXMWidgetLayout
...
from pyxscat.h5_integrator import PONI_KEY_BINNING, PONI_KEY_DISTANCE, PONI_KEY_SHAPE1, PONI_KEY_SHAPE2, PONI_KEY_DETECTOR, PONI_KEY_PIXEL1, PONI_KEY_PIXEL2, PONI_KEY_WAVELENGTH, PONI_KEY_PONI1, PONI_KEY_PONI2, PONI_KEY_ROT1, PONI_KEY_ROT2, PONI_KEY_ROT3
from pyxscat.h5_integrator import *
from gui.gui_layout import QZ_BUTTON_LABEL, QR_BUTTON_LABEL, MIRROR_BUTTON_LABEL
...
class GUIPyXMWidget(GUIPyXMWidgetLayout):
    ...
    def pick_hdf5_folder(self) -> Path:
        ...
        """
        # It has to be a Path where to search the data files
        if not self.h5._root_dir:
            self.write_terminal_and_loggerinfo(ERROR_MAINDIR_DONTEXIST)
            return
        
        dialog_h5_dir = QFileDialog.getExistingDirectory(self, 'Choose root directory', ".")
